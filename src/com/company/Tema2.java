...
public class Tema2 {
    ...
    public static void main(String[] args) {
        ...
        collectAndReverse(1, 2, 3, 4, 5, 6, 7, 8, 9);
        System.out.println("\n");
    ...
    public static void printAllElements(List<Object> list) {
        for (Object obj : list) {
     ...
     */
    // optimal answer
    public static void collectAndReverse(Integer... param) {
        List<Integer> list = new ArrayList<>();

        for (Integer arg : param) {
            list.add(arg);
        }
